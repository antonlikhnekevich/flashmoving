...
<!--allrecords-->
<div id="allrecords" class="t-records" data-hook="blocks-collection-content-node" data-tilda-project-id="80487" data-tilda-page-id="3653355" data-tilda-formskey="037c22c7d5e69bb5f455c2a4d760c441">
    <div id="rec68019698" class="r t-rec t-rec_pt_45 t-rec_pb_45" style="padding-top:45px;padding-bottom:45px; " data-animationappear="off" data-record-type="718">
        <!-- t718 -->
        <div class="t718">
            <div class="t-section__container t-container">
                <div class="t-col t-col_12">
                    <div class="t-section__topwrapper t-align_center">
                        ...
                        <div class="t-section__descr t-descr t-descr_xl t-margin_auto" field="bdescr">Feel free to write and call us
                            <br />We really love to communicate with our clients</div>
                    </div>
                </div>
            </div>
            <div class="t-container">
                    ...
                    <div class="t718__contentbox" style="height:;">
                        <div class="t718__contentwrapper">
                            <div class="t718__contacts t-text t-descr_xxxl" style="" field="text">
                                <br />
                                <br /><a href="tel:+18572418778" style="">+1 857 241 87 78</a>
                                <br /><a href="mailto:info@flashmoving.net" style="">info@flashmoving.net</a></div>
                            <div class="t718__address t-text t-text_sm" style="" field="text2">99 Rivermoon St., West Roxbury, MA, 02132</div>
                            <div class="t-sociallinks">
                                <div class="t-sociallinks__wrapper">
                                    ...
                                    <div class="t-sociallinks__item">
                                        <a href="https://twitter.com/flashmoversma?lang=en" target="_blank">
                                            <svg class="t-sociallinks__svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">
                                                <desc>Twitter</desc>
                ...
                <div class="t-col t-col_5 ">
                    <form id="form68019698" name='form68019698' role="form" action='' method='POST' data-formactiontype="2" data-inputbox=".t-input-group" data-success-url="http://flashmoving.net/" class="t-form js-form-proccess t-form_inputs-total_4 " data-success-callback="t718_onSuccess">
                        <input type="hidden" name="formservices[]" value="caf386dc0d585d8bed3499289803aabd" class="js-formaction-services">
                        <input type="hidden" name="tildaspec-formname" tabindex="-1" value="Contacts Page">
                        <div class="js-successbox t-form__successbox t-text t-text_md" style="display:none;"><strong>Thank you for getting in touch!</strong>
                            <br />
                            <br /> We appreciate you contacting us. One of our colleagues will get back to you shortly.
                            <br />
                            <br /> Have a great day!
                            <br />
                            <br />
                        ...
                        <div class="t-form__inputsbox">
                            <div class="t-input-group t-input-group_nm" data-input-lid="1496238250184">
                                <div class="t-input-block">
                                    <input type="text" name="Name" class="t-input js-tilda-rule " value="" placeholder="Your Full Name" data-tilda-req="1" data-tilda-rule="name" style=" border:1px solid #c7c7c7; ">
                                    <div class="t-input-error"></div>
                                </div>
                            </div>
                            <div class="t-input-group t-input-group_em" data-input-lid="1496238230199">
                                <div class="t-input-block">
                                    <input type="text" name="Email" class="t-input js-tilda-rule " value="" placeholder="Your E-mail" data-tilda-req="1" data-tilda-rule="email" style=" border:1px solid #c7c7c7; ">
                                    <div class="t-input-error"></div>
                                </div>
                            </div>
                            <div class="t-input-group t-input-group_ph" data-input-lid="1537760415349">
                                <div class="t-input-block">
                                    <input type="text" name="Phone" class="t-input js-tilda-rule " value="" placeholder="+1 123 456 7890" data-tilda-rule="phone" style=" border:1px solid #c7c7c7; ">
                                    <div class="t-input-error"></div>
                                </div>
                            </div>
                            <div class="t-input-group t-input-group_ta" data-input-lid="1496238259342">
                                <div class="t-input-block">
                                    <textarea name="Textarea" class="t-input js-tilda-rule " placeholder="Your comments" style=" border:1px solid #c7c7c7; height:102px" rows="3"></textarea>
                                    <div class="t-input-error"></div>
                                </div>
                            </div>
                            ...
                            <div class="t-form__submit">
                                <button type="submit" class="t-submit" style="color:#ffffff;background-color:#db4623;border-radius:30px; -moz-border-radius:30px; -webkit-border-radius:30px;">Send</button>
                            </div>
                        </div>
                    ...
                    <div class="t718__form-bottom-text t-text t-text_xs" field="text3">I agree to the Privacy Policy</div>
                </div>
            </div>
        </div>
    </div>
