...
if(req==1&&((val.length==0&&valnospace.length==0)||(($(this).attr('type')=='checkbox'||$(this).attr('type')=='radio')&&$(this).closest('form').find('[name="'+$(this).attr('name')+'"]:checked').length==0))){error.type.push('req')}else{switch(rule){case 'email':regExp=/^[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯0-9_\.\-\+]{1,64}@[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»0-9][a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»0-9\.\-]{0,253}\.[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯]{2,10}$/;if(val.length>0&&!val.match(regExp)){error.type.push('email')}
break;case 'url':regExp=/^((https?|ftp):\/\/)?[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»ÅŸÃ§0-9][a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»ÅŸÃ§0-9\.\-]{0,253}\.[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯]{2,10}\/?$/;if(val.length>0){str=val.split('//');if(str&&str.length>1){str=str[1]}else{str=str[0]}
